...
class UrbanRoutesAutomatedCard extends ProjectCard {
  get dataUrl() {
    return "./data/projects/urban-routes-automated.json";
  }
  ...
  render(data) {
    ...
    this.classList.add("urban-routes-automated-card");
  }
}

customElements.define("urban-routes-automated-card", UrbanRoutesAutomatedCard);
