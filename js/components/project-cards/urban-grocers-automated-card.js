...
class UrbanGrocersAutomatedCard extends ProjectCard {
  get dataUrl() {
    return "./data/projects/urban-grocers-automated.json";
  }
  ...
  render(data) {
    ...
    this.classList.add("urban-grocers-automated-card");
  }
}

customElements.define("urban-grocers-automated-card", UrbanGrocersAutomatedCard);
