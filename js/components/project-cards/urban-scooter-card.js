...
class UrbanScooterCard extends ProjectCard {
  get dataUrl() {
    return "./data/projects/urban-scooter.json";
  }
  ...
  render(data) {
    ...
    this.classList.add("urban-scooter-card");
  }
}

customElements.define("urban-scooter-card", UrbanScooterCard);
